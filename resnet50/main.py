...
def evaluate(model, val_loader, epoch=0, save_path='./best_model.pkl'):
    ...
    f = open("progress_adam.txt",'a')
    f.write('Test in epoch '+ str(epoch)+ ' Accuracy is '+ str(acc)+ ' Best accuracy is '+ str(best_acc))
    f.write('\n')
...
def main():
    ...
    parser.add_argument('--dataroot', type=str, default='./dataS/')
